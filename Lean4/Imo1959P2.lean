...
Adapted from mathlib4 Archive/Imo/Imo1959Q2.lean (tag v4.32.2) /
Compfiles Imo1959P2, the second International Mathematical Olympiad problem.
-/
...
/-- (a) The solutions for `A = √2` are exactly `x ∈ [1/2, 1]`. -/
